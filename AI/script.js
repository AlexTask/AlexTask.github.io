...
const texts = {
    ...
    'game': ['Мені подобається гра The Elder Scrolls V: Skyrim, а вам подобається?', "Я впевнений що ви грали в The Elder Scrolls V: Skyrim, грали?", "Розповісти вам про The Elder Scrolls V: Skyrim?"],
